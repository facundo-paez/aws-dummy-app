...
# boto3 configuration and get evironment variables
...
SECRET_KEY = 'django-insecure-su9t%b-2w_1njze_99!rcn&*55(skiuczt#j^l=vsysi(fk^_y'
...
ALLOWED_HOSTS = get_param('ALLOWED_HOSTS').split(',')
...
AWS_STATICFILES_STORAGE_BUCKET_NAME = get_param('STATICFILES_STORAGE_BUCKET_NAME', default=AWS_STORAGE_BUCKET_NAME)
